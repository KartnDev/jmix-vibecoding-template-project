...
- Demonstrate how to configure AI coding assistants (Cursor, Claude Code, Junie, Continue.dev) for Jmix
...
## AI Configuration Files (AI-README)

AI-README files are project-specific instruction files that AI coding assistants automatically read and inject into their context at session start. Each platform looks for a specific filename:

| File | Tool | Auto-read |
|------|------|-----------|
| [`CLAUDE.md`](CLAUDE.md) | Claude Code | Yes (case-sensitive) |
| [`.cursorrules`](.cursorrules) | Cursor IDE | Yes |
| [`AGENTS.md`](AGENTS.md) | OpenAI Codex, Cursor, Continue | Yes |
| [`.junie/guidelines.md`](.junie/guidelines.md) | Junie | Yes |
| [`.github/copilot-instructions.md`](.github/copilot-instructions.md) | GitHub Copilot | Yes |
| [`.continuerules`](.continuerules) | Continue.dev | Yes |

**Purpose:** Define project rules, forbidden patterns, and conventions that the agent must follow. Without AI-README, models hallucinate incorrect APIs and patterns.

**Universal file:** [`AGENTS.md`](AGENTS.md) — read by multiple platforms (Cursor, Continue, Codex). Use as primary AI-README for cross-platform compatibility.
...
![mcp_idea_setup.png](resources/mcp_idea_setup.png)
...
Located in [`ai-docs/skills/`](ai-docs/skills/) — each skill is a folder with `SKILL.md`:
...
Located in [`ai-docs/rules/`](ai-docs/rules/) — each rule is a folder with `RULE.md`:
...
|----------|---------------|---------------|--------------|
| Cursor | Yes (`.cursor/skills/`) | Yes (`.cursor/rules/`) | By file path |
